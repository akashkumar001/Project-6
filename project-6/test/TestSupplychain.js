...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[2],2, 'Error Item is not packed')
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[2],3,"Error State is not same")
        assert.equal(resultBufferTwo[1],1000000000000000000n,"Error: Price not set")

        assert.equal(eventEmitted,true, "Event is not emitted")
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        assert.equal(resultBufferTwo[2],4, 'Error Item not bought')
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        assert.equal(resultBufferTwo[2],5, 'Error Item not bought')
        assert.equal(eventEmitted, true ,"Event not emitted")
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        assert.equal(resultBufferTwo[2],6, 'Error Item not bought')
        assert.equal(eventEmitted, true ,"Event not emitted")
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        assert.equal(resultBufferTwo[2],7, 'Error Item not bought')
        assert.equal(eventEmitted, true ,"Event not emitted")
    ...
    it("Testing smart contract function fetchItemBufferOne() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferOne[4], originFarmInformation, 'Error: Missing or Invalid originFarmInformation')
        assert.equal(resultBufferOne[5], originFarmLatitude, 'Error: Missing or Invalid originFarmLatitude')
        assert.equal(resultBufferOne[6], productNotes, 'Error: Missing or Invalid originFarmLongitude')
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        const resultBufferTwo = await supplyChain.fetchItemBufferTwo.call(upc)
        assert.equal(resultBufferTwo[0], upc, 'Error: Invalid item UPC')
        assert.equal(resultBufferTwo[6], productID, 'Error: Missing or Invalid productID')
        
        assert.equal(resultBufferTwo[1], productPrice, 'Error: Missing or Invalid productPrice')
        assert.equal(resultBufferTwo[3], distributorID, 'Error: Missing or Invalid distributorID')
        assert.equal(resultBufferTwo[4], retailerID, 'Error: Missing or Invalid retailerID')
        assert.equal(resultBufferTwo[5], consumerID, 'Error: Missing or Invalid consumerID')
